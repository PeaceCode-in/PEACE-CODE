...
> = {
  ...
  lavender: {
    outer: "bg-gradient-to-b from-[#9667e0] to-[#d4bbfc]",
    inner: "bg-gradient-to-b from-[#fbfaff] via-[#d4bbfc] to-[#ebd9fc]",
    button: "bg-gradient-to-b from-[#ebd9fc] to-[#d4bbfc]",
    textColor: "text-[#9667e0]",
    textShadow: "[text-shadow:_0_-1px_0_rgb(150_103_224_/_30%)]",
  },
};
...
const MetalButton = React.forwardRef<
  HTMLButtonElement,
  MetalButtonProps
>(({ children, className, variant = "lavender", ...props }, ref) => {
